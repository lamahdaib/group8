...
root.configure(bg="#F5E6D3")

lbl = Label(
    root,
    text="Jordanian Dishes",
    font=("Arial", 20, "bold"),
    bg="#4E342E",
    fg="#D4AF37",
    pady=12
...
frame_left = Frame( frame_main, bg="#8D6E63")
frame_left.pack(side=LEFT, fill=Y)
frame_right = Frame(frame_main, bg="#FFF8E7")
frame_right.pack(side=LEFT, fill=BOTH, expand=True)

jordan_items = [
                 { "name": "Mansaf","category": "Food","desc": "National dish of Jordan made with lamb and jameed."},
...
def show_details(event):
    ...
    item = jordan_items[selected_index[0]]
